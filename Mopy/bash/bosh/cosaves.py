...
from ..bolt import AFile, GPath, Path, deprint, pack_4s, pack_byte, \
    pack_double, pack_float, pack_int, pack_int_signed, pack_short, \
    struct_error, struct_pack, struct_unpack, unpack_4s, unpack_byte, \
    unpack_double, unpack_float, unpack_int, unpack_int_signed, unpack_short, \
    unpack_spaced_string, unpack_str16, unpack_str32, PluginStr
...
class _Remappable(object):
    ...
    def remap_plugins(self, plugin_renames: dict[PluginStr, PluginStr]):
